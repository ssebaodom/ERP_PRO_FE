      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{ flexDirection: "column", gap: "8px" }}
          >
            <span className="default_bold_label">Số từ - số đến</span>
            <div className="default_modal_group_items">
              <Form.Item
                name="invoiceNumStart"
                rules={[
                  {
                    required: false,
                    message: "Vui lòng điền số chứng từ",
                  },
                ]}
              >
                <Input placeholder="Số từ" />
              </Form.Item>
              <Form.Item
                name="invoiceNumEnd"
                rules={[
